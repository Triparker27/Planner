/* planner.js (fixed + upgraded)
   - Calendar shows icons for classes, assignments, quizzes
   - Day modal shows full details for all events on that date
   - Import / Export JSON for classes, assignments, quizzes
*/
